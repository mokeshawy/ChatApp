...
class RegistrationViewModel : ViewModel() {
    ...
    fun registerNewAccount( context : Context , view : View , btn_sign_up : Button){
            ...
            if(etEnterName.value!!.trim().isEmpty()){
                ...
                firebaseAuth.createUserWithEmailAndPassword(etEnterEmail.value!!.toString() , etEnterPassword.value!!.toString()).addOnCompleteListener { it ->
                    if(it.isSuccessful){
                        ...
                        accountReference.child(userId.toString()).setValue(map).addOnCompleteListener { setValue ->
    ...
    //Fun go to login page
    fun goLogInPage(context : Context , view : View , btn_log_in : Button){
